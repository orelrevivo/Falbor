    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2">
                <h3 className="text-xl font-bold tracking-tight">Project Plugins</h3>
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {pluginsList.map((plugin) => (
                        <div key={plugin.id} className="border border-gray-200 rounded-lg p-5 flex flex-col justify-between bg-white hover:border-blue-200 transition-colors shadow-sm">
                            <div className="space-y-2 mb-4">
                                <h4 className="font-bold text-gray-900 tracking-tight">{plugin.name}</h4>
                                <p className="text-xs text-gray-500 line-clamp-2">{plugin.tagline}</p>
                            </div>
                            <div className="flex items-center justify-between border-t border-gray-50 pt-3">
                                ...
                                <Button 
                                    ...
                                    className="bg-blue-50 text-blue-600 hover:bg-blue-100 border-none font-bold"
                                >
