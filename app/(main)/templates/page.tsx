...
// ── Page ──────────────────────────────────────────────
import { TemplatesTabs } from "@/components/workbench/templates/TemplatesTabs"
import { plugins } from "@/config/schema"

export const metadata = {
    title: "Templates & Plugins | Falbor",
    description: "Browse and clone templates and plugins created by the community",
}
    ...
    return (
        <div className="p-6 sm:p-8">
            <h1 className="text-3xl md:text-4xl font-bold text-center mt-6 mb-3">
                Community <span className="text-primary">Marketplace</span>
            </h1>

            <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-10 pb-4">
                Start faster by cloning high-quality templates and plugins shared by the community
            </p>

            <TemplatesTabs templatesData={templatesData} pluginsData={pluginsData} />
        </div>
    )
}
