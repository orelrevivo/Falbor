            ...
            try {
                ...
                if (!window.crossOriginIsolated) {
                    ...
                    if (!alreadyTriedReload) {
                        ...
                        // Already reloaded once and still not isolated ΓÇö show error
                ...
                // Isolation confirmed ΓÇö clear any previous reload flag
  ...
  plugins: {
    ...
    useEffect(() => {
        const handleBuildAndDeploy = async (e: any) => {
            ...
            try {
                // Always get a fresh token here ΓÇö the token passed via the event may be
                ...
                // Refresh the token right before the deploy request ΓÇö the build can take
